...
;; Теперь, все что нам осталось это вычислить выражение в постфиксной записи, следуя
;; Алгоритму Дейкстры. К сожалению унарный минус в этой реализации не поддерживается.
...
;; Попробуем вычислить указанные ранее выражения:
;; (calculate (to-postfix '([ 1 + 2 ] * 4 + 3))) => 15
;; (calculate (to-postfix '(3 + [ 10 - 15 ]))) => -2
